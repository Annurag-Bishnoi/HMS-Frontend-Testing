...
export default function PharmacistDetailsModal({ staff, onClose, onUpdate }: PharmacistDetailsModalProps) {
          ...
          <div className="mt-8 rounded-2xl border border-slate-100 bg-slate-50 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2 text-slate-800">
                ...
                <h3 className="font-semibold">Pharmacist Login Access</h3>
              </div>
              {!credentials && (
                <button
            ...
            {credentials && (
              <div className="rounded-xl bg-amber-50 p-4 border border-amber-100 animate-fade-in">
                ...
                <p className="text-xs text-amber-600 mt-3 text-center">
                  Please provide these to the pharmacist.
                </p>
              </div>
            )}
          </div>
