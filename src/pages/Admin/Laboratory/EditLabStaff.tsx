...
export default function EditLabStaff() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast("Failed to update laboratory staff: " + (err.response?.data?.message || err.message, "error"));
    } finally {
      setSaving(false);
    }
  };

  const goBack = () => navigate("/admin/laboratory");
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center animate-fade-in">
        <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-sm text-center border border-slate-100">
          ...
          <p className="mb-8 text-slate-500">The laboratory staff details have been successfully updated.</p>
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 p-6 animate-fade-in">
      ...
      <div>
        <h1 className="text-3xl font-bold">Edit Lab Staff</h1>
