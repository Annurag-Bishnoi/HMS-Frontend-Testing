    ...
    <div className="space-y-6 animate-fade-in pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage the hospital's medication inventory, request stock, and set reorder alerts.</p>
        </div>
      ...
      <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl flex items-start gap-3">
        ...
        <div>
          <h4 className="text-sm font-bold text-amber-800">Pharmacy Workspace</h4>
          <p className="text-sm text-amber-700 mt-1 leading-relaxed">
            This workspace allows you to directly interface with the central inventory. Add stock batches, suspend medications that are out-of-stock indefinitely, and set live reorder threshold alerts.
          </p>
        </div>
      </div>
